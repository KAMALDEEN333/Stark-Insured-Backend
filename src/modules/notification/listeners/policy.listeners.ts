...
export class PolicyEventListeners {
  ...
  handlePolicyIssued(event: PolicyIssuedEvent): void {
    ...
    this.notificationService.createNotification({
      ...
      type: 'policy',
      title: 'Policy Issued',
      message: `Your insurance policy (ID: ${event.policyId}) has been issued and is now active.`,
    });
  }
  ...
  handlePolicyRenewed(event: PolicyRenewedEvent): void {
    ...
    this.notificationService.createNotification({
      ...
      message: `Your insurance policy (ID: ${event.policyId}) has been successfully renewed.`,
    });
  }
  ...
  handlePolicyExpired(event: PolicyExpiredEvent): void {
    ...
    this.notificationService.createNotification({
      ...
      message: `Your insurance policy (ID: ${event.policyId}) has expired. Please renew to maintain coverage.`,
    });
  }
  ...
  handlePolicyCancelled(event: PolicyCancelledEvent): void {
    ...
    this.notificationService.createNotification({
      ...
      message: `Your insurance policy (ID: ${event.policyId}) has been cancelled. Reason: ${event.reason}`,
    });
  }
}
